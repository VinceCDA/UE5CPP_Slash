...
void AWeapon::Equip(USceneComponent* InParent, FName InSocketName, AActor* NewOwner, APawn* NewInstigater)
{
	SetOwner(NewOwner);
	SetInstigator(NewInstigater);
...
void AWeapon::AttachMeshToSocket(USceneComponent* InParent, const FName& InSocketName)
{
	...
	DisableParticlesEffect();
}

void AWeapon::DisableParticlesEffect()
{
	if (NiagaraParticles)
	{
